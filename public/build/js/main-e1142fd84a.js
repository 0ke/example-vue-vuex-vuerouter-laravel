...
},{"windowsill":91}],62:[function(require,module,exports){
/**
 * Before Interceptor.
 */
...
},{"./events":90,"debounce":56,"tiny-emitter":59}],92:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.getRandomPlaylist = exports.getUsersPlaylist = exports.isUserAuthenticated = exports.userWasAuthenticated = exports.toggleLocale = exports.togglescheme = undefined;

var _mutationTypes = require('./mutation-types');

var togglescheme = exports.togglescheme = function togglescheme(_ref) {
  var dispatch = _ref.dispatch;
  return dispatch(_mutationTypes.TOGGLESCHEME);
};
var toggleLocale = exports.toggleLocale = function toggleLocale(_ref2) {
  var dispatch = _ref2.dispatch;
  return dispatch(_mutationTypes.TOGGLELOCALE);
};

var userWasAuthenticated = exports.userWasAuthenticated = function userWasAuthenticated(_ref3, response) {
  var dispatch = _ref3.dispatch;
  var state = _ref3.state;
  return dispatch(_mutationTypes.USERAUTHENTICATED, response);
};

var isUserAuthenticated = exports.isUserAuthenticated = function isUserAuthenticated(_ref4) {
  var dispatch = _ref4.dispatch;
  var state = _ref4.state;
  return dispatch(_mutationTypes.ISUSERAUTHENTICATED);
};

var getUsersPlaylist = exports.getUsersPlaylist = function getUsersPlaylist(_ref5) {
  var dispatch = _ref5.dispatch;
  var state = _ref5.state;
  return dispatch(_mutationTypes.USERPLAYLIST);
};

var getRandomPlaylist = exports.getRandomPlaylist = function getRandomPlaylist(_ref6, queue) {
  var dispatch = _ref6.dispatch;
  var state = _ref6.state;
  return dispatch(_mutationTypes.RANDOMPLAYLIST, queue);
};

},{"./mutation-types":94}],93:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.recentHistory = recentHistory;
function recentHistory(state) {
  var end = state.history.length;
  var begin = end - 5 < 0 ? 0 : end - 5;
...
var TOGGLESCHEME = exports.TOGGLESCHEME = 'TOGGLESCHEME';
var TOGGLELOCALE = exports.TOGGLELOCALE = 'TOGGLELOCALE';
var AUTHENTICATEUSER = exports.AUTHENTICATEUSER = 'AUTHENTICATEUSER';
var ISUSERAUTHENTICATED = exports.ISUSERAUTHENTICATED = 'ISUSERAUTHENTICATED';
...
exports.default = {
  ...
  components: {
    languageswitcher: require('./components/widgets/languageswitcher.vue')
  },
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  var id = "/Users/jonasvanderhaegen/Uni-t/testing/example-vue-vuex-vuerouter-laravel/resources/assets/js/vue/app.vue"
  if (!module.hot.data) {
...
},{"./Vuex/actions":92,"./components/widgets/languageswitcher.vue":103,"./vuex/store":108,"vue":87,"vue-hot-reload-api":60,"vue-resize-mixin":61}],96:[function(require,module,exports){
"use strict";
if (module.exports.__esModule) module.exports = module.exports.default
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/jonasvanderhaegen/Uni-t/testing/example-vue-vuex-vuerouter-laravel/resources/assets/js/vue/components/pages/contact/create.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
},{"vue":87,"vue-hot-reload-api":60}],97:[function(require,module,exports){
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/jonasvanderhaegen/Uni-t/testing/example-vue-vuex-vuerouter-laravel/resources/assets/js/vue/components/pages/errors/404.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
exports.default = {
    ...
    vuex: {
        getters: {
            shortlocale: function shortlocale(state) {
                return state.shortlocale;
            },
            longlocale: function longlocale(state) {
                return state.longlocale;
            }
        }
    },
    data: function data() {
    ...
    route: {
        data: function data(transition) {
            this.$http.get('home').then(function (response) {
    ...
    filters: {
        seo: function seo(value, attribute) {
            var seo = value.seo[0];
            switch (attribute) {
                case 'title':
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/jonasvanderhaegen/Uni-t/testing/example-vue-vuex-vuerouter-laravel/resources/assets/js/vue/components/pages/general/home.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
},{"vue":87,"vue-hot-reload-api":60}],100:[function(require,module,exports){
'use strict';
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/jonasvanderhaegen/Uni-t/testing/example-vue-vuex-vuerouter-laravel/resources/assets/js/vue/components/pages/posts/index.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
},{"babel-runtime/core-js/promise":1,"vue":87,"vue-hot-reload-api":60}],101:[function(require,module,exports){
'use strict';
...
exports.default = {
	...
	route: {
		data: function data(transition) {
			...
			return new _promise2.default(function (resolve) {
				_this.$http.get('article/' + transition.to.params.slug).then(function (response) {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/jonasvanderhaegen/Uni-t/testing/example-vue-vuex-vuerouter-laravel/resources/assets/js/vue/components/pages/posts/show.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
},{"../../../Vuex/actions":92,"../../../Vuex/getters":93,"babel-runtime/core-js/promise":1,"vue":87,"vue-hot-reload-api":60}],102:[function(require,module,exports){
'use strict';
...
},{"vue":87,"vue-hot-reload-api":60}],103:[function(require,module,exports){
'use strict';
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<a>{{ shortlocale }}</a>\n<ul>\n    <li><a @click=\"toggleLocale\">{{ longlocale }}</a></li>\n</ul>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/jonasvanderhaegen/Uni-t/testing/example-vue-vuex-vuerouter-laravel/resources/assets/js/vue/components/widgets/languageswitcher.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
},{"../../Vuex/actions":92,"vue":87,"vue-hot-reload-api":60}],104:[function(require,module,exports){
'use strict';
...
_vue2.default.transition('googletransition', {
	enterClass: 'fadeInUp',
	leaveClass: 'fadeOutDown'
});
_vue2.default.transition('googletransition2', {
	enterClass: 'fadeIn',
	leaveClass: 'fadeOut'
});
...
},{"./app.vue":95,"./route-config":105,"./vuex/store":108,"vue":87,"vue-resource":75,"vue-router":86,"vuex-router-sync":88}],105:[function(require,module,exports){
'use strict';
...
function configRouter(router) {
    ...
    router.beforeEach(function (transition) {
        console.log('before routing to component');
    });

    router.afterEach(function (transition) {
        console.log('after routing to component');
    });
}

},{"./components/pages/contact/create.vue":96,"./components/pages/errors/404.vue":97,"./components/pages/general/about.vue":98,"./components/pages/general/home.vue":99,"./components/pages/posts/index.vue":100,"./components/pages/posts/show.vue":101,"./components/pages/users/team.vue":102}],106:[function(require,module,exports){
arguments[4][94][0].apply(exports,arguments)
},{"dup":94}],107:[function(require,module,exports){
'use strict';
...
var _TOGGLESCHEME$TOGGLEL;

var _mutationTypes = require('./mutation-types');

function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }

exports.default = (_TOGGLESCHEME$TOGGLEL = {}, _defineProperty(_TOGGLESCHEME$TOGGLEL, _mutationTypes.TOGGLESCHEME, function (state) {
  state.scheme = !state.scheme;
}), _defineProperty(_TOGGLESCHEME$TOGGLEL, _mutationTypes.TOGGLELOCALE, function (state) {
  state.shortlocale = state.shortlocale == 'nl' ? 'en' : 'nl';
  state.longlocale = state.longlocale == 'english' ? 'nederlands' : 'english';
}), _defineProperty(_TOGGLESCHEME$TOGGLEL, _mutationTypes.USERAUTHENTICATED, function (state, response) {
  //console.log( state )
  state.auth.user = response.user;
  state.auth.user.isLoggedIn = true;
  state.auth.user.roles = response.roles;
  localStorage.setItem('auth', JSON.stringify(state.auth));
}), _defineProperty(_TOGGLESCHEME$TOGGLEL, _mutationTypes.ISUSERAUTHENTICATED, function (state) {
  if (localStorage.getItem("auth") !== null) {
    state.auth = JSON.parse(localStorage.getItem('auth'));
  }
}), _defineProperty(_TOGGLESCHEME$TOGGLEL, _mutationTypes.USERPLAYLIST, function (state) {
  if (localStorage.getItem("queue") !== null) {
    state.music.queue.songs = JSON.parse(localStorage.getItem('queue'));
  }
}), _defineProperty(_TOGGLESCHEME$TOGGLEL, _mutationTypes.RANDOMPLAYLIST, function (state, queue) {
  //console.log( state )
  state.music.queue.songs = queue;
  localStorage.setItem('queue', JSON.stringify(state.music.queue.songs));
}), _TOGGLESCHEME$TOGGLEL);

},{"./mutation-types":106}],108:[function(require,module,exports){
'use strict';
...
if (module.hot) {
  module.hot.accept(['../mutations'], function () {
    var mutations = require('../mutations').default;
    store.hotUpdate({
      mutations: mutations
    });
  });
...
},{"../mutations":107,"vue":87,"vuex":89}]},{},[104]);
