...
exports.default = {
  ...
  components: {
    ...
    menu: require('./components/partials/menu.vue')
  },
...
var _data = {
  ...
  children: [{ name: 'app.vue' }, { name: 'main.js' }, { name: 'route-config.js' }, {
    name: 'vuex',
    children: [{
      name: 'store',
      children: [{ name: 'index.js' }]
    }, { name: 'actions.js' }, { name: 'getters.js' }, { name: 'setters.js' }, { name: 'mutations.js' }, { name: 'mutation-types.js' }]
  }, {
    name: 'components',
    children: [{
      name: 'pages',
      children: [{
        name: 'general',
        children: [{ name: 'home.vue' }, { name: 'about.vue' }]
      }, {
        name: 'auth',
        children: [{ name: 'login.vue' }, { name: 'register.vue' }]
      }, {
        name: 'posts',
        children: [{ name: 'index.vue' }, { name: 'show.vue' }]
      }, {
        name: 'users',
        children: [{ name: 'index.vue' }, { name: 'posts.vue' }, { name: 'settings.vue' }, { name: 'show.vue' }, { name: 'team.vue' }]
      }, {
        name: 'contact',
        children: [{ name: 'archive.vue' }, { name: 'create.vue' }, { name: 'index.vue' }, { name: 'show.vue' }]
      }, {
        name: 'errors',
        children: [{ name: '404.vue' }]
      }]
    }, {
      name: 'partials',
      children: [{ name: 'menu.vue' }]
    }, {
      name: 'widgets',
      children: [{ name: 'languageswitcher.vue' }, { name: 'navtree.vue' }]
    }]
  }]
};
...
exports.default = {
  ...
  methods: {
    ...
    toggleComponent: function toggleComponent() {
      this.passingData = false;
      this.routing = false;
...
exports.default = {
        ...
        return {
            text: {
                ...
                sometext: {
                    ...
                    en: 'A curated list of awesome things related to Vue.js'
                }
            }
        };
    },
    ...
    filters: {
        locale: function locale(value, attribute) {

            switch (attribute) {
                case 'title':
                    return this.shortlocale == 'nl' ? value.title.nl : value.title.en;
                    break;
                case 'sometext':
                    return this.shortlocale == 'nl' ? value.sometext.nl : value.sometext.en;
                    break;
            }
        }
    }
...
exports.default = {
	...
	filters: {
		checkForSubtypes: function checkForSubtypes(value) {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/jonasvanderhaegen/Uni-t/testing/example-vue-vuex-vuerouter-laravel/resources/assets/js/vue/components/partials/menu.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n\n<ul class=\"nav navbar-nav navbar-right\">\n    <li class=\"dropdown\">\n        <a href=\"#\" class=\"dropdown-toggle\" data-toggle=\"dropdown\" role=\"button\" aria-haspopup=\"true\" aria-expanded=\"false\">{{ shortlocale | uppercase }} <span class=\"caret\"></span></a>\n        <ul class=\"dropdown-menu\">\n            <li><a @click=\"toggleLocale\">{{ longlocale | uppercase }}</a></li>\n        </ul>\n    </li>\n</ul>\n\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/jonasvanderhaegen/Uni-t/testing/example-vue-vuex-vuerouter-laravel/resources/assets/js/vue/components/widgets/navtree.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
